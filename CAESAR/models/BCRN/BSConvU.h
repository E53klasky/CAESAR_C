...
struct BSConvUImpl : public torch::nn::Module {
    ...
    BSConvUImpl(
        ...
        // Convert string padding_mode to torch enum
        ...
        // Pointwise convolution (matches Python "pw")
        ...
        // Batch normalization (matches Python "bn", if requested)
        if (with_bn) {
        ...
        // Depthwise convolution (matches Python "dw")
