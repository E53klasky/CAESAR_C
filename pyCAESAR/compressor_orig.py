...
class CAESAR:
    def __init__(self, 
                 model_path, 
                 use_diffusion=True, 
                 device='cuda', pca_device='cuda',  n_frame = 16, interpo_rate=3, diffusion_steps = 32
                 ):
    ...
    def postprocessing_encoding(self, original_data, recons_data, nrmse):
        ...
        #self.device
        self.compressor = PCACompressor(nrmse, 2, codec_algorithm = "Zstd", device = self.pca_device)
